...
urlpatterns = [
    ...
    path('stats/', views.stats, name='hospital-stats'),
    ...
    path('visitprocess/', views.visit_process, name='hospital-v-process'),
    ...
    path('service/update/', views.update_service, name='hospital-service-update'),
    path('salary/update/', views.update_salary, name='hospital-salary-update'),
    path('salary/', views.salary, name='hospital-salary'),
